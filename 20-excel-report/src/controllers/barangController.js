...
const getAllBarang = async (req, res, next) => {
  try {
    ...
    next(
      new Error("controllers/barangController.js:getAllBarang - " + err.message)
    );
  }
};
...
const insertBarang = async (req, res, next) => {
  try {
    ...
    next(
      new Error("controllers/barangController.js:insertBarang - " + err.message)
    );
  }
};
...
const setNewBarang = async (req, res, next) => {
  try {
    ...
    next(
      new Error("controllers/barangController.js:setNewBarang - " + err.message)
    );
  }
};
...
const editBarang = async (req, res, next) => {
  try {
    ...
    next(
      new Error("controllers/barangController.js:editBarang - " + err.message)
    );
  }
};
...
const setEditBarang = async (req, res, next) => {
  try {
    ...
    next(
      new Error(
        "controllers/barangController.js:setEditBarang - " + err.message
      )
    );
  }
};
